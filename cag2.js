...
app.use(express.static(path.join(__dirname, 'front_public'), { maxAge : 31536000000 }));
...
// 系统功能模块
require('./modules/age/agectl').bindurl(app);
require('./modules/author/authorctl').bindurl(app);
require('./modules/media/mediactl').bindurl(app);
