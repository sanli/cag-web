...
/**
 * ageHTTP入口模块, 需要在主文件中添加map
 * var age = require('./routes/age').bindurl(app);
 */
'use strict';
var agedb = require('./agedb.js')
    // base function
...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/bg/age.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/bg/age/create', exports.create);
    share.bindurl(app, '/bg/age/update', exports.update);
    share.bindurl(app, '/bg/age/list', exports.list);

    share.bindurl(app, '/bg/age/get', exports.get);
    share.bindurl(app, '/bg/age/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/bg/age/delete', exports.delete);
    share.bindurl(app, '/bg/age/count', exports.count);


    share.bindurl(app, '/bg/age/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
...
exports.create = function(req, res){
    ...
    agedb.create(arg.data, function(err, newDoc){
...
exports.update = function(req, res){
    ...
    var data = arg.data;
    delete data._id;
    agedb.update( arg._id , data , function(err, cnt){
        if(err) {
            console.log(err);
...
exports.list = function(req, res){
    ...
    agedb.list(arg.cond, arg.sort, page, function(err, docs){
...
exports.count = function(req, res){
    ...
    share.searchCondExp(arg.cond);
    share.fillUserDataRule(arg.cond, req);
    agedb.count(arg.cond, function(err, count){
        if(err) return share.rt(false, err.message, res);
...
exports.get = function(req, res){
    ...
    agedb.findById(arg._id, function(err, doc){
...
exports.retriveByCond = function(req, res){ 
    ...
    agedb.findByCond(arg.cond, function(err, doc){
        if(err) return share.rt(false, `查询${module_desc}出错:` + err.message, res);
...
exports.delete = function(req, res){
    ...
    agedb.delete(arg._id , function(err, doc){
