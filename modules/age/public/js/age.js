//#!本文件由share.js自动产生, 命令行为: node sharecli.js gen age
...
var Module = $.extend(new $M(), {
    ...
    createModule: function(){
        function _createModule(condition, fn, fail){
            $M.doupdate('/bg/age/create', condition, { successfn : fn , failfn: fail});
        };
        ...
        // ....
        // 文件上传组件
        $('#module-form').find('div.uploadpanel').each(function(i, el){
            $(el).uploadPanel({}, { multi : false });
        });
        ...
        $.showmodal('#moduleDlg', function(fn){
            if ($('#module-form').validate().form()){
                ...
                // ...
                $('#module-form').find('div.uploadpanel').each(function(i, el){
                    $(el).fillUploadFile(data, { multi : false });
                });     
    ...
    viewModule : function(id , options){
        ...
        Module.loadDataDetail(id, function(module){
            ...
            // ...
            $('#module-form-view').find('div.file-panel').each(function(i, el){
                $(el).filePanel(data, { multi : false, container : '#moduleViewDlg' });
            });
        });
    ...
    updateModule: function(id, options){
        ...
        Module.loadDataDetail(id, function(module){
            ...
            // ...
            $('#module-form').find('div.uploadpanel').each(function(i, el){
                $(el).uploadPanel(data, { multi : false });
            });
        });
    ...
    updateModuleInfo : function(condition, fn, fail){
        $M.doupdate('/bg/age/update', condition, { successfn : fn , failfn: fail});
    },

    // 查询详细信息
    loadDataDetail : function(id, fn){
        $M.doquery('/bg/age/get', {_id : id}
            , { successfn : fn , alertPosition : '#cellDiv'});
    }
