...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/bg/media.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/bg/media/create', exports.create);
    share.bindurl(app, '/bg/media/update', exports.update);
    share.bindurl(app, '/bg/media/list', exports.list);

    share.bindurl(app, '/bg/media/listnavi', exports.listnavi);

    share.bindurl(app, '/bg/media/get', exports.get);
    share.bindurl(app, '/bg/media/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/bg/media/delete', exports.delete);
    share.bindurl(app, '/bg/media/count', exports.count);


    share.bindurl(app, '/bg/media/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
