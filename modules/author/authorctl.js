//#!本文件由share.js自动产生, 命令行为: node share.js gen author
/**
 * authorHTTP入口模块, 需要在主文件中添加map
 * var author = require('./routes/author').bindurl(app);
 */
'use strict';
var authordb = require('./authordb.js')
    // base function
...
// 模块相关的全局属性
const module_name = 'author', module_desc = '作者';
...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/bg/author.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/bg/author/create', exports.create);
    share.bindurl(app, '/bg/author/update', exports.update);
    share.bindurl(app, '/bg/author/list', exports.list);

    share.bindurl(app, '/bg/author/get', exports.get);
    share.bindurl(app, '/bg/author/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/bg/author/delete', exports.delete);
    share.bindurl(app, '/bg/author/count', exports.count);


    share.bindurl(app, '/bg/author/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
...
exports.create = function(req, res){
    ...
    authordb.create(arg.data, function(err, newDoc){
...
exports.update = function(req, res){
    ...
    var data = arg.data;
    delete data._id;
    authordb.update( arg._id , data , function(err, cnt){
        if(err) {
            console.log(err);
...
exports.list = function(req, res){
    ...
    authordb.list(arg.cond, arg.sort, page, function(err, docs){
...
exports.count = function(req, res){
    ...
    share.searchCondExp(arg.cond);
    share.fillUserDataRule(arg.cond, req);
    authordb.count(arg.cond, function(err, count){
        if(err) return share.rt(false, err.message, res);
...
exports.get = function(req, res){
    ...
    authordb.findById(arg._id, function(err, doc){
...
exports.retriveByCond = function(req, res){ 
    ...
    authordb.findByCond(arg.cond, function(err, doc){
        if(err) return share.rt(false, `查询${module_desc}出错:` + err.message, res);
...
exports.delete = function(req, res){
    ...
    authordb.delete(arg._id , function(err, doc){
